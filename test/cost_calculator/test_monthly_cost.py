...
class TestMonthlyCost:
    ...
    cost_with_gas_mod = MonthlyCostCalculator(gas_modulated=True, billing_cost=billing_cost)
    cost_without_gas_mod = MonthlyCostCalculator(gas_modulated=False, name="no_mod", billing_cost=billing_cost)
